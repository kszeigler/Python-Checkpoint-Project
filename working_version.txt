def main():
  ...
  print("It's weird because you're pretty sure you went to sleep in you're comfy bed at home.") 
  print("How odd!")
  print(" ")
  ...
  if answer == 1 and num > 3 and weapon >= 1:
    ...
    if riches >= 10:
      ...
      print("The dragon doesn't care and swipes its tail and damages you.")
    ...
    if riches >= 10:
      ...
      print("The dragon didn't seem to care. It swipes its tail and damages you.")
